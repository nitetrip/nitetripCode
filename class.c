...
// Spell assignment below is from April 2012
...
/* Priest  Levels 1 - 9*/
  spell_level(TYPE_UNDEFINED,TYPE_UNDEFINED, SPELL_ARMOR, CLASS_PRIEST, 1);
  spell_level(TYPE_UNDEFINED,TYPE_UNDEFINED, SPELL_BLESS, CLASS_PRIEST, 2);
  spell_level(SPELL_CURE_BLIND,TYPE_UNDEFINED, SPELL_BLINDNESS, CLASS_PRIEST, 8);
  spell_level(TYPE_UNDEFINED,TYPE_UNDEFINED, SPELL_CREATE_WATER, CLASS_PRIEST, 1);
  spell_level(SPELL_CREATE_WATER, TYPE_UNDEFINED, SPELL_CREATE_FOOD, CLASS_PRIEST, 2);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CURE_BLIND, CLASS_PRIEST, 5);
  spell_level(TYPE_UNDEFINED,TYPE_UNDEFINED, SPELL_CURE_LIGHT, CLASS_PRIEST, 3);
  spell_level(TYPE_UNDEFINED,TYPE_UNDEFINED, SPELL_DETECT_POISON, CLASS_PRIEST, 3);
  spell_level(TYPE_UNDEFINED,TYPE_UNDEFINED, SPELL_VIGORIZE_LIGHT, CLASS_PRIEST, 5);
  spell_level(SPELL_VIGORIZE_LIGHT, TYPE_UNDEFINED, SPELL_VIGORIZE_SERIOUS, CLASS_PRIEST, 7);
  spell_level(SPELL_VIGORIZE_SERIOUS, TYPE_UNDEFINED, SPELL_VIGORIZE_CRITICAL, CLASS_PRIEST, 9);
  spell_level(TYPE_UNDEFINED,TYPE_UNDEFINED, SPELL_CAUSE_MINOR, CLASS_PRIEST, 4);
  spell_level(SPELL_CAUSE_MINOR, TYPE_UNDEFINED, SPELL_CAUSE_MAJOR, CLASS_PRIEST, 7);
  spell_level(TYPE_UNDEFINED,TYPE_UNDEFINED, SPELL_FEATHER_FALL, CLASS_PRIEST, 6);
  spell_level(TYPE_UNDEFINED,TYPE_UNDEFINED, SPELL_DETECT_EVIL, CLASS_PRIEST, 6);
  spell_level(TYPE_UNDEFINED,TYPE_UNDEFINED, SPELL_DETECT_GOOD, CLASS_PRIEST, 4);
  spell_level(SPELL_DETECT_GOOD, SPELL_DETECT_EVIL, SPELL_DETECT_NEUTRAL, CLASS_PRIEST, 8);
  spell_level(SPELL_CURE_LIGHT, TYPE_UNDEFINED, SPELL_CURE_SERIOUS, CLASS_PRIEST, 6);
  spell_level(TYPE_UNDEFINED,TYPE_UNDEFINED, SPELL_MAGICAL_VESTMANTS, CLASS_PRIEST, 9);


/* Shaman Level 10 - 24 */

  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CONTROL_WEATHER, CLASS_SHAMAN, 11);
  spell_level(SPELL_CURE_LIGHT, SPELL_CURE_SERIOUS, SPELL_CURE_CRITIC, CLASS_SHAMAN, 10);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_DETECT_ALIGN, CLASS_SHAMAN, 18);
  spell_level(SPELL_REMOVE_POISON, TYPE_UNDEFINED, SPELL_POISON, CLASS_SHAMAN, 14);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_REMOVE_POISON, CLASS_SHAMAN, 10);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_WATERWALK, CLASS_SHAMAN, 11);
  spell_level(SPELL_HEAL_LIGHT, TYPE_UNDEFINED, SPELL_HEAL_SERIOUS, CLASS_SHAMAN, 24);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_VITALIZE_MANA, CLASS_SHAMAN, 22);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SEARING_ORB, CLASS_SHAMAN, 19);
  spell_level(SPELL_BLESS, TYPE_UNDEFINED, SPELL_REGENERATION, CLASS_SHAMAN, 12);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_DISPEL_MAGIC, CLASS_SHAMAN, 23);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CONJURE_ELEMENTAL, CLASS_SHAMAN, 16);
  spell_level(SPELL_CURE_CRITIC, TYPE_UNDEFINED, SPELL_HEAL_LIGHT, CLASS_SHAMAN, 20);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_HOLD_ANIMAL, CLASS_SHAMAN, 15);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_HOLD_BEAST, CLASS_SHAMAN, 13);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_PACIFY, CLASS_SHAMAN, 17);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_VITALITY, CLASS_SHAMAN, 16);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_ELEMENTAL_SHIELD, CLASS_SHAMAN, 24);

/* Cleric Level 10-24 */

  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CURE_CRITIC, CLASS_CLERIC, 10);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CURSE, CLASS_CLERIC, 16);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_DETECT_INVIS, CLASS_CLERIC, 17);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_DISPEL_EVIL, CLASS_CLERIC, 18);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_HARM, CLASS_CLERIC, 10);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_PROT_FROM_EVIL, CLASS_CLERIC, 22);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SANCTUARY, CLASS_CLERIC, 15);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SUMMON_LESSER, CLASS_CLERIC, 13);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_WORD_OF_RECALL, CLASS_CLERIC, 12);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SENSE_LIFE, CLASS_CLERIC, 10);
  spell_level(SPELL_HEAL_LIGHT, TYPE_UNDEFINED, SPELL_HEAL_SERIOUS, CLASS_CLERIC, 22);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_VITALIZE_MANA, CLASS_CLERIC, 17);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_FLAMESTRIKE, CLASS_CLERIC, 2);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_DREAMSIGHT, CLASS_CLERIC, 12);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_FREE_ACTION, CLASS_CLERIC, 19);
  spell_level(SPELL_DISPEL_SILENCE, TYPE_UNDEFINED, SPELL_SILENCE, CLASS_CLERIC, 13);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_AID, CLASS_CLERIC, 11);
  spell_level(SPELL_CURE_CRITIC, TYPE_UNDEFINED, SPELL_HEAL_LIGHT, CLASS_CLERIC, 18);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_DISPEL_SILENCE, CLASS_CLERIC, 11);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_GATE, CLASS_CLERIC, 13);
  spell_level(SPELL_CREATE_FOOD, TYPE_UNDEFINED, SPELL_HEROES_FEAST, CLASS_CLERIC, 13);
 // spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_REMOVE_PARALYSES, CLASS_CLERIC, 21);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SHIELD_AGAINST_EVIL, CLASS_CLERIC, 17);

/* Monk Level 25-40 */
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CHI_FIST, CLASS_MONK, 35);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_HEALING_WIND, CLASS_MONK, 27);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_FLAMESTRIKE, CLASS_MONK, 26);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_HEALING_DREAM, CLASS_MONK, 30);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_INVISIBILITY_TO_ENEMIES, CLASS_MONK, 32);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SECOND_SIGHT, CLASS_MONK, 33);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SLEEPWALK, CLASS_MONK, 25);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_POWER_STRIKE, CLASS_MONK, 38);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_WINDWALK, CLASS_MONK, 29);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_DEATH_STRIKE, CLASS_MONK, 40);


/* Druid Level 25 - 40 */
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_EARTHQUAKE, CLASS_DRUID, 27);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SUSTAIN, CLASS_DRUID, 26);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SOVEREIGN_HEAL, CLASS_DRUID, 30);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_ICE_STORM, CLASS_DRUID, 33);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_BOULDER, CLASS_DRUID, 39);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_METEOR, CLASS_DRUID, 27);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_METEOR_SHOWER, CLASS_DRUID, 40);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_THUNDER_SWARM, CLASS_DRUID, 34);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_ELEMENTAL_SHARD, CLASS_DRUID, 28);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_HORNET_SWARM, CLASS_DRUID, 27);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_HEAL_CRITICAL, CLASS_DRUID, 25);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_ELEMENTAL_BURST, CLASS_DRUID, 26);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_ELEMENTAL_HANDS, CLASS_DRUID, 29);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_ELEMENTAL_STRIKE, CLASS_DRUID, 29);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_HORNETS_DART, CLASS_DRUID, 32);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SUSTAIN_GROUP, CLASS_DRUID, 38);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_ANIMAL_FRIENDSHIP, CLASS_DRUID, 26);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_BEFRIEND_DRYAD, CLASS_DRUID, 25);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CHARM_BEAST, CLASS_DRUID, 27);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CONTROL_PLANT, CLASS_DRUID, 29);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_ELEMENTAL_AURA, CLASS_DRUID, 32);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_HOLD_PLANT, CLASS_DRUID, 28);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_PASS_WITHOUT_TRACE, CLASS_DRUID, 26);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_TRAIL_OF_WOODLANDS, CLASS_DRUID, 35);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_MOON_MOTE, CLASS_DRUID, 28);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_VITALITY, CLASS_DRUID, 25);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_ELEMENTAL_BLAST, CLASS_DRUID, 29);

/* Disciple Level 25-40 */
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_GROUP_ARMOR, CLASS_DISCIPLE, 25);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_GROUP_HEAL, CLASS_DISCIPLE, 40);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_GROUP_RECALL, CLASS_DISCIPLE, 35);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SOVEREIGN_HEAL, CLASS_DISCIPLE, 29);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_HEAL_CRITICAL, CLASS_DISCIPLE, 27);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_DIVINE_HEAL, CLASS_DISCIPLE, 37);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_MASS_HEAL, CLASS_DISCIPLE, 38);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_EXCOMMUNICATE, CLASS_DISCIPLE, 30);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SMITE_EVIL, CLASS_DISCIPLE, 33);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_HOLY_WORD, CLASS_DISCIPLE, 36);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CALM, CLASS_DISCIPLE, 31);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SUMMON_GREATER, CLASS_DISCIPLE, 26);

/* Crusader Level 25-40 */
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_VIGORIZE_GROUP, CLASS_CRUSADER, 29);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SMITE_EVIL, CLASS_CRUSADER, 33);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_REFLECT_DAMAGE, CLASS_CRUSADER, 38);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_DRAW_UPON_HOLY_MIGHT, CLASS_CRUSADER, 27);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SYNOSTODWEOMER, CLASS_CRUSADER, 28);
...
/* Mage Level 1 - 10 */
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_ARMOR, CLASS_MAGIC_USER, 5);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_TELEPORT, CLASS_MAGIC_USER, 10);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_BURNING_HANDS, CLASS_MAGIC_USER, 9);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CONTROL_WEATHER, CLASS_MAGIC_USER, 1);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_DETECT_INVIS, CLASS_MAGIC_USER, 4);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_DETECT_MAGIC, CLASS_MAGIC_USER, 2);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_MAGIC_MISSILE, CLASS_MAGIC_USER, 1);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_HASTE, CLASS_MAGIC_USER, 10);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_FEATHER_FALL, CLASS_MAGIC_USER, 7);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_FLEET_FEET, CLASS_MAGIC_USER, 8);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_INVISIBLE, CLASS_MAGIC_USER, 6);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_KNOCK, CLASS_MAGIC_USER, 3);

/* Battle Mage Level 11-25 */
  spell_level(SPELL_CONTROL_WEATHER, TYPE_UNDEFINED, SPELL_CALL_LIGHTNING, CLASS_BATTLEMAGE, 11);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CHILL_TOUCH, CLASS_BATTLEMAGE, 13);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_COLOR_SPRAY, CLASS_BATTLEMAGE, 24);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_EARTHQUAKE, CLASS_BATTLEMAGE, 16);
  spell_level(SPELL_CALL_LIGHTNING, TYPE_UNDEFINED, SPELL_LIGHTNING_BOLT, CLASS_BATTLEMAGE, 22);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SHOCKING_GRASP, CLASS_BATTLEMAGE, 19);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_STRENGTH, CLASS_BATTLEMAGE, 15);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_AIRWALK, CLASS_BATTLEMAGE, 16);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_VITALIZE_MANA, CLASS_BATTLEMAGE, 17);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_PHASE_DOOR, CLASS_BATTLEMAGE, 20);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_BIND_PORTAL_MINOR, CLASS_BATTLEMAGE, 21);
  spell_level(SPELL_BIND_PORTAL_MINOR, TYPE_UNDEFINED, SPELL_BIND_PORTAL_MAJOR, CLASS_BATTLEMAGE, 25);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_FUMBLE, CLASS_BATTLEMAGE, 12);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_HOLD_MONSTER, CLASS_BATTLEMAGE, 14);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_HOLD_PERSON, CLASS_BATTLEMAGE, 18);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SHIELD, CLASS_BATTLEMAGE, 23);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SUCCOR, CLASS_BATTLEMAGE, 28);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_ASPHYXIATE, CLASS_BATTLEMAGE, 28);

/*  Enchanter Level 11-25 */
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_ENERGY_DRAIN, CLASS_ENCHANTER, 15);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_IMPROVED_INVISIBILITY, CLASS_ENCHANTER, 22);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_LOCATE_OBJECT, CLASS_ENCHANTER, 21);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_ENCHANT_WEAPON, CLASS_ENCHANTER, 15);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SLEEP, CLASS_ENCHANTER, 18);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SENSE_LIFE, CLASS_ENCHANTER, 12);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_INFRAVISION, CLASS_ENCHANTER, 11);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SPOOK, CLASS_ENCHANTER, 19);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_AIRWALK, CLASS_ENCHANTER, 16);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_VITALIZE_MANA, CLASS_ENCHANTER, 20);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_TELEVIEW_MINOR, CLASS_ENCHANTER, 23);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_BAT_SONAR, CLASS_ENCHANTER, 24);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_DEATHS_DOOR, CLASS_ENCHANTER, 14);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SHIELD_AGAINST_GOOD, CLASS_ENCHANTER, 13);

/* Chaos Mage Level 26-40 */
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_FIREBALL, CLASS_CHAOSMAGE, 27);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_FINGER_OF_DEATH, CLASS_CHAOSMAGE, 39);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_BALL_LIGHTNING, CLASS_CHAOSMAGE, 32);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CHAIN_LIGHTNING, CLASS_CHAOSMAGE, 29);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SHADOW_ARMOR, CLASS_CHAOSMAGE, 37);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CHAMPIONS_STRENGTH, CLASS_CHAOSMAGE, 38);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CHARM_PERSON, CLASS_CHAOSMAGE, 26);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_INTIMIDATE, CLASS_CHAOSMAGE, 30);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_STRENGTH_BURST, CLASS_CHAOSMAGE, 26);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_ICE_LANCE, CLASS_CHAOSMAGE, 28);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CLONE, CLASS_CHAOSMAGE, 40);

/* Sorceror Level 26-40 */
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_GROUP_ARMOR, CLASS_SORCEROR, 39);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_PILLAR_OF_FLAME, CLASS_SORCEROR, 40);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_PRISMATIC_SPRAY, CLASS_SORCEROR, 26);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CLENCHED_FIST, CLASS_SORCEROR, 28);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_FIREBOLT, CLASS_SORCEROR, 27);
  spell_level(SPELL_CLENCHED_FIST, TYPE_UNDEFINED, SPELL_FLAILING_FISTS, CLASS_SORCEROR, 33);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CHARM_MONSTER, CLASS_SORCEROR, 30);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_DIMENSION_SHIFT, CLASS_SORCEROR, 36);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_DIMENSION_WALK, CLASS_SORCEROR, 28);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_DIMENSION_DOOR, CLASS_SORCEROR, 35);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SCRY_GREATER, CLASS_SORCEROR, 31);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SCRY_LESSER, CLASS_SORCEROR, 29);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SUNBURST, CLASS_SORCEROR, 32);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SUNRAY, CLASS_SORCEROR, 34);

/*  Necromancer Level 26-40 */
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CURSE, CLASS_NECROMANCER, 26);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_ANIMATE_DEAD, CLASS_NECROMANCER, 27);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CLOAK_OF_DARKNESS, CLASS_NECROMANCER, 36);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CLOAK_OF_SHADOWS, CLASS_NECROMANCER, 32);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CLOAK_OF_THE_NIGHT, CLASS_NECROMANCER, 34);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SHADOW_ARMOR, CLASS_NECROMANCER, 37);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_GRANT_BAT_SONAR, CLASS_NECROMANCER, 35);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CANNIBALIZE, CLASS_NECROMANCER, 26);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CHARM_MONSTER, CLASS_NECROMANCER, 31);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CHARM_PERSON, CLASS_NECROMANCER, 30);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CONJURE_UNDEAD, CLASS_NECROMANCER, 32);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CONTROL_UNDEAD, CLASS_NECROMANCER, 34);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_EMBALM, CLASS_NECROMANCER, 28);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_FEIGN_DEATH, CLASS_NECROMANCER, 29);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_GHOUL_GAUNTLET, CLASS_NECROMANCER, 26);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_GHOUL_TOUCH, CLASS_NECROMANCER, 28);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_HOLD_UNDEAD, CLASS_NECROMANCER, 35);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_LOCATE_SHADOW_PLANE, CLASS_NECROMANCER, 33);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_PLANAR_TRAVEL, CLASS_NECROMANCER, 37);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_PROTECTION_FROM_GOOD, CLASS_NECROMANCER, 29);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_REST_IN_PEACE, CLASS_NECROMANCER, 39);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SHADOW_DOOR, CLASS_NECROMANCER, 34);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SHADOW_WALK, CLASS_NECROMANCER, 39);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SKELETAL_GUISE, CLASS_NECROMANCER, 31);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_BLOOD_QUENCH, CLASS_NECROMANCER, 27);

/* Alchemist Level 26-40 */
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_DECREPIFY, CLASS_ALCHEMIST, 29);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_TELEVIEW_MAJOR, CLASS_ALCHEMIST,37 );
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_CHAMPIONS_STRENGTH, CLASS_ALCHEMIST, 40);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_DISPEL_MAGIC, CLASS_ALCHEMIST, 27);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_DISPEL_SILENCE, CLASS_ALCHEMIST, 27);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_RECHARGE, CLASS_ALCHEMIST, 35);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_ENFEEBLEMENT, CLASS_ALCHEMIST, 28);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_ENLARGE, CLASS_ALCHEMIST, 33);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_FLAMEWALK, CLASS_ALCHEMIST, 34);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_IMMUNITY_TO_COLD, CLASS_ALCHEMIST, 38);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_IMMUNITY_TO_ELEC, CLASS_ALCHEMIST, 39);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_RESISTANCE_TO_COLD, CLASS_ALCHEMIST, 28);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_RESISTANCE_TO_ELEC, CLASS_ALCHEMIST, 29);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_SHRINK, CLASS_ALCHEMIST, 34);
  spell_level(TYPE_UNDEFINED, TYPE_UNDEFINED, SPELL_WITHER, CLASS_ALCHEMIST, 26);
