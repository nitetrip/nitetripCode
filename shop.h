...
#define IS_GOD(ch)		(!IS_NPC(ch) && (GET_LEVEL(ch) >= LVL_DEITY))
...
#define TRADE_NOSKNIGHT         (1 << 11)
#define TRADE_NOPALADIN         (1 << 12)
#define TRADE_NOASSASSIN	(1 << 13)
#define TRADE_NOCHAOSMAGE	(1 << 14)
...
#define NOTRADE_SKNIGHT(i)      (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOSKNIGHT))
...
#define NOTRADE_CHAOSMAGE(i)	(IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOCHAOSMAGE))
