...
/* minimum level a player must be to shout/yell/gossip/auction */
int level_can_shout = 1;

/* number of movement points it costs to shout */
int shout_move_cost = 0;
 ...
 * this from LVL_SAINT gives the top level that people can advance to
 * in gain_exp() in limits.c
 * For example, to stop people from advancing to LVL_SAINT, simply set
...
/* Autowipe deletion criteria
   ...
   * Element 5, level LVL_SAINT - 1, days 60: All other mortals get
	60 days.
...
/* rooms for tp zones - mak 5.14.05 */
room_vnum arcane_library_room = 8400; /* jester tp zone */

room_vnum first_forest_room = 8500; /* druid tp zone */

room_vnum ethereal_plane_room = 8700; /* CHM/alc tp zone */

room_vnum astral_plane_room = 10400; /* sorceror/alchemist tp zone */

room_vnum shadow_plane_room = 11600; /* necro tp zone */

/* virtual number of room that immorts should enter at by default */
room_vnum immort_start_room = 506;

/* virtual number of room that frozen players should enter at */
room_vnum frozen_start_room = 4298;
 ...
 * donation rooms.
 */
room_vnum donation_room_1 = 4020;
...
const char *MENU =
"\r\n"
"Welcome to Sorin Mud!\r\n"
"0) Exit from Sorin Mud.\r\n"
"1) Enter the game.\r\n"
"2) Enter description.\r\n"
...
"\r\n"
"Welcome to the land of Sorin!  May your visit here be... Interesting."
"\r\n\r\n";

const char *START_MESSG =
"Welcome.  This is your new Sorin Mud character!  You can now earn gold,\r\n"
