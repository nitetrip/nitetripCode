...
struct affected_type {
   ...
   bool round_duration;  // if true duration is in rounds, else ticks
...
struct game_data {
  ...
  int yell_move_cost;     /* Cost to yell in move points.         */
  ...
  int death_penalty;      /* Type of penalty players face when they die */
